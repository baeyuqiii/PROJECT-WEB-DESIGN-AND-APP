...
if (isset($_POST['add_to_cart'])) {
    ...
    $itemPrice = $_POST['itemPrice'];
     ...
     $existingCartItem = mysqli_query($conn, "SELECT * FROM cart WHERE itemName = '$itemName' LIMIT 1");
    
    if (mysqli_num_rows($existingCartItem) > 0) {
    
        $cartItem = mysqli_fetch_assoc($existingCartItem);
        $newQuantity = $cartItem['itemQuantity'] + 1;
        $itemId = $cartItem['itemId'];
        $updateQuantityQuery = mysqli_query($conn, "UPDATE cart SET itemQuantity = $newQuantity WHERE itemId = $itemId");
        ...
        $sql = "INSERT INTO cart (itemName, itemPrice, itemQuantity) VALUES ('$itemName', $itemPrice, 1)";
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-contact">
                <h3>Sign up to stay up-to-date on all our latest arrivals!</h3>
