   ...
   $check_query = mysqli_query($conn, "SELECT * FROM `cart` WHERE itemId = '$item_id'");
    if (mysqli_num_rows($check_query) > 0) {
        ...
        if ($insert_query) {
            ...
            // Error handling if the item couldn't be added tcho the cart
...
<body>
    <div class="n">
        <div class="title">
            ...
            <b><p style="background-color: maroon; padding: 10px 20px;"> <a href="kpopc.php" style="text-decoration: none; color: white;">K-POP</p></b>
